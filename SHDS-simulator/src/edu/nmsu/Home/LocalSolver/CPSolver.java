...
public abstract class CPSolver implements Solver {
    ...
    protected long timeoutMs = 10000;

    /** The solving time horizon */
    protected final int HORIZON = Parameters.getHorizon();

    /** It specifies the scale factors to round double numbers to integers. */
    protected final int kiloWattToWatt = 100;   // used for power
    ...
    /**
     * It specifies simple search method based on inputs order and lexigraphical
