        ...
        try {
            ...
            else if (type.equals("actuator"))
            {
                ...
                while (keys.hasNext()) {
                    ...
                    double actionPower = jAction.getDouble("power_consumed") * Parameters.getGran() / 60; // <---- I added granularity to this
                    ...
                    for (int i = 0; i < jEffects.length(); i++) {
                        ...
                        double delta = jEffect.getDouble("delta") * Parameters.getGran() / 60;
