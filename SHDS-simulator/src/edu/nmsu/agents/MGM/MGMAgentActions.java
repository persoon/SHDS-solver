...
public class MGMAgentActions extends AgentActions {
    ...
    public MGMAgentActions(MGMAgentState agentState, long solver_timeout, double w_price, double w_power)
    {
        super(agentState);
        ...
        solver.setTimeoutMs(solver_timeout);
    ...
    public boolean computeFirstSchedule()
    {
        ...
        //System.setErr(outStream);
        T2 = System.currentTimeMillis();
        //System.out.println("solve time:" + T2 - T1);
        mgmAgentState.setSolvingTimeMs(T2 - T1);
